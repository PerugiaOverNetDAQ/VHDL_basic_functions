--!@file parametric_fifo_synch_MLAB.vhd
--!@brief Parametric FIFO from the IP-catalog component scfifo, forced to use MLAB mem
--!@author Mattia Barbanera, mattia.barbanera@infn.it & Luca Russo, luca.russo@cern.ch, luca.russo912@gmail.com
--!@date 30/04/2026
--!@version 0.1 -
...
entity parametric_fifo_synch_MLAB is
  generic(
...
end parametric_fifo_synch_MLAB;

architecture SYN of parametric_fifo_synch_MLAB is
  component scfifo
    generic (
